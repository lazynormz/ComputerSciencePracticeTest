...
public class CarDealerShipTest
{
    ...
    public void testSortCarsByPrice()
    {
        ...
        Car result1 = one;
        Car result2 = two;
        Assertions.assertEquals(result0, instance.getCarsForSale().get(0));
        Assertions.assertEquals(result1, instance.getCarsForSale().get(1));
        Assertions.assertEquals(result2, instance.getCarsForSale().get(2));
    }
    ...
    public void testPresentRandomCarToCustomer()
    {
        ...
        Assertions.assertEquals(expected, distOne, 0.01);
        Assertions.assertEquals(expected, distTwo, 0.01);
        Assertions.assertEquals(expected, distThree, 0.01);
    }
